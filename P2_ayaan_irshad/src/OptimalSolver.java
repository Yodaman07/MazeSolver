...
public class OptimalSolver {
	...
	Map map;
	ArrayList<Point> realPath = new ArrayList<Point>();
	...
	private boolean solverHelper(Point pos, ArrayList<Point> history, ArrayList<Point> path, char finding, int level) {
